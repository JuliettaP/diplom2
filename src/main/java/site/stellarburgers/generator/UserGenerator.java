...
import site.stellarburgers.utils.LoginUser;
import site.stellarburgers.utils.RegisterUser;

public class UserGenerator {

    final static String DEFAULT_EMAIL = "jullietaP@yandex.ru";
    final static String DEFAULT_PASSWORD = "123";
    final static String DEFAULT_NAME = "Julia";
    ...
    final static String NEW_NAME = "Julietta";
